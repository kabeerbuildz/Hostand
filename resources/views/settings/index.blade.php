                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('first_name', null, ['class' => 'form-control', 'placeholder' => __('Enter your name'), 'required' => 'required']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{ Form::label('last_name', __('Last Name'), ['class' => 'form-label']) }}
                                                    {{ Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => __('Enter your name')]) }}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('phone_number', null, ['class' => 'form-control', 'placeholder' => __('Enter your phone number')]) }}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                ...
                                <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}" id="company_settings" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('company_business_name', __('Business Name (Ragione Sociale)'), ['class' => 'form-label']) }}
                                                {{ Form::text('company_business_name', $settings['company_business_name'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter business name')]) }}
                                            </div>
                                            ...
                                            {{-- P.IVA / VAT --}}
                                            <div class="form-group col-md-6">
                                                {{ Form::label('company_vat', __('VAT Number (P.IVA)'), ['class' => 'form-label']) }}
                                                {{ Form::text('company_vat', $settings['company_vat'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter VAT number')]) }}
                                            </div>

                                            {{-- Codice Fiscale --}}
                                            <div class="form-group col-md-6">
                                                {{ Form::label('company_tax_code', __('Tax Code (Codice Fiscale)'), ['class' => 'form-label']) }}
                                                {{ Form::text('company_tax_code', $settings['company_tax_code'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter tax code')]) }}
                                            </div>
                                            ...
                                            {{-- PEC --}}
                                            <div class="form-group col-md-6">
                                                {{ Form::label('company_pec', __('PEC (Certified Email)'), ['class' => 'form-label']) }}
                                                {{ Form::text('company_pec', $settings['company_pec'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter PEC email')]) }}
                                            </div>
