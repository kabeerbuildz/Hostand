{{ Form::open(['route' => 'unit.direct-store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::select('property_id', $name, null, ['class' => 'form-control hidesearch', 'placeholder' => __('Select Property'), 'id' => 'property_id_select']) }}
        </div>
        ...
        <div class="form-group col-md-12 holiday-home-hide bnb-hotel-hide">
            ...
            {{ Form::text('sign_detail', null, ['class' => 'form-control', 'placeholder' => __('Enter sign on door or other identifying detail')]) }}
        </div>

        <!-- Description -->
        <div class="form-group col-md-12 bnb-hotel-hide">
            {{ Form::label('description', __('Description'), ['class' => 'form-label']) }}
            {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => 4, 'placeholder' => __('Enter Property Description')]) }}
        </div>
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            const propertySelect = $('#property_id_select');
            const nameLabel = $('#unit-name-label');
            
            console.log('Property select found:', propertySelect.length > 0);
            ...
            if (propertySelect.length > 0) {
                ...
                propertySelect.on('change', function() {
                    ...
                    if (!propertyId) {
                        // Reset to default if no property selected
                        resetFieldsToDefault();
                        return;
                    }
                    
                    // Fetch property location type
                    $.ajax({
                ...
                // Also trigger on initial load if a property is already selected
