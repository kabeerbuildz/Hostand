                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <div class="form-group ">
                                                            ...
                                                            {{ Form::select('type', $types, null, ['class' => 'form-control basic-select', 'required' => 'required', 'id' => 'property_type_main']) }}
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="card-body">
            ...
            <div class="row unit_list" data-index="0">
                <div class="form-group col-md-4">
                    {{ Form::label('units[0][unitname]', __('Name'), ['class' => 'form-label']) }}
                ...
                <div class="col-sm-4">
                    <div class="mb-3">
                        <div class="form-group">
                            {{ Form::label('units[0][sofa_bed]', __('Sofa Bed'), ['class' => 'form-label']) }}
                            {{ Form::select('units[0][sofa_bed]', ['yes' => 'Yes', 'no' => 'No'], null, ['class' => 'form-control', 'data-field' => 'sofa_bed', 'required' => 'required']) }}
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="access-code-fields" style="display:none;">
                    <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="mb-3">
                        <div class="form-group">
                            {{ Form::label('units[0][sign_detail]', __('Sign/Identifying Detail'), ['class' => 'form-label']) }}
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // STEP 1: Property Details Tab Validation
        nextButton.addEventListener('click', function(e) {
            const requiredFields = document.querySelectorAll('.propertyDetails [required]');
        ...
        // STEP 3: Final Submit Button Validation
        submitButton.addEventListener('click', function(e) {
            ...
            if (!isValid) {
                ...
                console.warn('Validation failed. Missing required fields:', Array.from(requiredFields).filter(f => !f.value || !String(f.value).trim()).map(f => f.name));
                e.preventDefault();
                e.stopImmediatePropagation();
                $('#property-submit').attr('disabled', false);
            } else {
